#
# spec file for package system-role-transactional-server
#
...
#   https://github.com/yast/system-role-transactional-server repository
#
...
%define role_name transactional-server
